...
public sealed class PhoneNumberTests
{
    ...
    [Fact(DisplayName = "Formats phone number as (NPA) NXX-XXXX")]
    public void ToFormattedString_ReturnsFormattedPhoneNumber()
    {
        // Arrange
        ErrorOr<PhoneNumber> result = PhoneNumber.CreateNorthAmerican("5551234567");
        PhoneNumber phoneNumber = result.Value;

        // Act
        string formatted = phoneNumber.ToFormattedString();

        // Assert
        formatted.ShouldBe("(555) 123-4567");
    }

    [Fact(DisplayName = "Formats phone number without extension when extension is null")]
    public void ToFormattedStringWithExtension_WithoutExtension_ReturnsFormattedPhoneNumberOnly()
    {
        // Arrange
        ErrorOr<PhoneNumber> result = PhoneNumber.CreateNorthAmerican("5551234567");
        PhoneNumber phoneNumber = result.Value;
        ...
        // Act
        string formatted = phoneNumber.ToFormattedStringWithExtension();

        // Assert
        formatted.ShouldBe("(555) 123-4567");
    }

    [Fact(DisplayName = "Formats phone number with extension when extension is present")]
    public void ToFormattedStringWithExtension_WithExtension_ReturnsFormattedPhoneNumberWithExtension()
    {
        // Arrange
        ErrorOr<PhoneNumber> result = PhoneNumber.CreateNorthAmerican("5551234567", "123");
        PhoneNumber phoneNumber = result.Value;
        ...
        // Assert
        formatted.ShouldBe("(555) 123-4567 x123");
    }
