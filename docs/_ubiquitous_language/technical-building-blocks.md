...
**Definition:** A value object representing a file stored by the system, including its location, metadata, and content information. This is a cross-cutting concern used across multiple bounded contexts for file storage (photos, documents, etc.).
...
- Used for Hall of Fame photos, and potentially other file storage needs in the future
...
- **Hall of Fame photos:** HallOfFameInduction.Photo property stores an optional photo of the inductee
- **Future use cases:** Tournament flyers, award certificates, bowler profile pictures
