...
namespace Neba.Website.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260120212035_TournamentFiles")]
    partial class TournamentFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Neba.Website.Domain.Tournaments.TournamentChampion", b =>
                {
            ...
            modelBuilder.Entity("Neba.Website.Domain.Tournaments.TournamentFile", b =>
                {
                    b.Property<int>("db_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "File", "Neba.Website.Domain.Tournaments.TournamentFile.File#StoredFile", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasKey("db_id")
                        .HasName("pk_tournament_files");

                    b.HasAlternateKey("Id")
                        .HasName("ak_tournament_files_domain_id");

                    b.HasIndex("tournament_id")
                        .HasDatabaseName("ix_tournament_files_tournament_id");

                    b.ToTable("tournament_files", "website");
                });
            ...
            modelBuilder.Entity("Neba.Website.Domain.Tournaments.TournamentFile", b =>
                {
                    b.HasOne("Neba.Website.Domain.Tournaments.Tournament", "Tournament")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tournament_files_tournaments_tournament_id");
