...
{
    /// <inheritdoc />
    public partial class TournamentDocuments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tournament_documents",
                schema: "website",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_tournament_documents", x => x.id);
                    table.UniqueConstraint("ak_tournament_documents_domain_id", x => x.domain_id);
                    table.ForeignKey(
                        name: "fk_tournament_documents_tournaments_tournament_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tournament_documents_tournament_id",
                schema: "website",
                table: "tournament_documents",
