...
public static class StoredFileConfiguration
{
    ...
    /// <param name="locationColumnName">Database column name for the file location (default: "file_location").</param>
    /// <param name="fileNameColumnName">Database column name for the file name (default: "file_name").</param>
    ...
    public static void OwnsStoredFile<T>(
        ...
        string locationColumnName = "file_location",
            ...
            where T : class
    {
        ...
        {
            file.Property(f => f.Location)
                .HasColumnName(locationColumnName)
                .HasMaxLength(63)
                .IsRequired();
