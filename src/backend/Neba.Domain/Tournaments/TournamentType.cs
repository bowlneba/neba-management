    ...
    : SmartEnum<TournamentType>
{
    ...
    /// </summary>
    public static readonly TournamentType NonChampions = new("Non-Champions", 11, 1);

    /// <summary>
    /// Tournament of Champions event.
    /// </summary>
    public static readonly TournamentType TournamentOfChampions = new("Tournament of Champions", 12, 1);
    ...
    /// Women tournament.
    /// </summary>
    public static readonly TournamentType Women = new("Women", 17, 1);
    ...
    /// </summary>
    public static readonly TournamentType OverUnderFortyDoubles = new("Over/Under 40 Doubles", 22, 2);
