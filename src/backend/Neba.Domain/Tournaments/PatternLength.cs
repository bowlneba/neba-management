...
/// in feet.
/// Inherits from <see cref="SmartEnum{PatternLength}"/> for enhanced enum-like behavior.
/// </summary>
public sealed class PatternLength
    : SmartEnum<PatternLength>
{
    /// <summary>
    /// Short pattern (less than 38 feet).
    /// </summary>
    public static readonly PatternLength ShortPattern = new(nameof(ShortPattern), 1, null, 37);

    /// <summary>
    /// Medium pattern (38 to 42 feet).
    /// </summary>
    public static readonly PatternLength MediumPattern = new(nameof(MediumPattern), 2, 38, 42);

    /// <summary>
    /// Long pattern (43 feet or more).
    /// </summary>
    public static readonly PatternLength LongPattern = new(nameof(LongPattern), 3, 43, null);
